    ...
    <section className={styles.statistics}>
        <div className="container">
            <div className={styles.upper}>
                ...
                <div className={`bold-61 ${styles.title}`}>Scale and adapt at the <span>speed <img src="https://firebasestorage.googleapis.com/v0/b/score-website-1391b.appspot.com/o/webp%2Fspeed.webp?alt=media&token=6e504508-3eab-4d1c-bd2a-a3421d675585" alt="highlight" width="100" height="100" /></span> of your bussines</div>
            ...
            <div className={styles.lower}>
                <div className={styles.photo}>
                    <img src="https://firebasestorage.googleapis.com/v0/b/score-website-1391b.appspot.com/o/webp%2FFrame-statistics.webp?alt=media&token=5e0db670-909e-43e5-ba37-3cf80c79e449" alt="statistics-photo" width="500" height="500" />
                </div>
